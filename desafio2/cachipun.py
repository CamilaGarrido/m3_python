...
if len(sys.argv) != 2 or sys.argv[1] not in opciones_validas:
    
    # Paso 3: Mostrar un mensaje de error si el argumento es invalido
    print("Argumento inválido. Debe ser piedra, papel o tijera.")
    sys.exit(1)

# Paso 4: Obtener la elección del usuario y la elección aleatoria del pc 
eleccion_usuario = sys.argv[1]
eleccion_computadora = random.choice(opciones_validas)

# Paso 5: Imprimir las elecciones del usuario y del pc 
print("El usuario escogió:", eleccion_usuario)
print("La computadora escogió:", eleccion_computadora)

# Paso 6: Determinar el resultado del juego
